...
async function startPulling() {
  ...
  const domains = ['allgemeinmedizin', 'impfung-covid-19-corona', 'innere-und-allgemeinmediziner', 'hausarztliche-versorgung', 'impfung-impfberatung', 'einzelpraxis', 'gemeinschaftspraxis']
  var centerURLs = []
