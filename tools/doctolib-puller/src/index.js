...
async function startPulling() {
  ...
  const domains = [
    ...
    'endokrinologe',
    'ergotherapie',
    'ernahrungsberatung-a1090070-2878-40fd-aa5e-faf264495f6b',
    ...
    'gynakologische-endokrinologie-und-reproduktionsmedizin',
    ...
    'herzchirurg',
    'horgerateakustiker',
    'facharzt-fur-humangenetik',
    'hygiene-umweltmediziner',
    'hausarztlich-tatige-internist-in',
    'facharzt-fur-innere-medizin-und-angiologie',
    'innere-und-allgemeinmediziner',
    'kinder-hamatologe-und-onkologe',
    'kinder-kardiologe',
    'kinderchirurgie',
    'kinder-und-jugendlichenpsychotherapeut',
    'kinder-jugendpsychiatrie-und-psychotherapie-2',
    'kinder-radiologe',
    'kosmetikerin',
    'labor',
    ...
    'mkt-therapeut-in-medizinische-kraftigungstherapie',
    'm-sc-kieferorthopadie',
    'mund-kiefer-gesichtschirurgie',
    'naturheilkunder',
    'neonatologe',
    'nephrologe',
    'arzt-fur-nervenheilkunde',
    'neurochirurgie',
