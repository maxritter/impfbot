...
conf = {'muc1': {'all_id': -1001464001536, 'mrna_id': -1001126966895, 'vec_id': -1001161931395, 'lat': 48.13836, 'lng': 11.57939, 'address': '80333 Muenchen Altstadt-Lehel'},
        ...
        'cgn': {'all_id': -1001439806320, 'mrna_id': -1, 'vec_id': -1, 'lat': 50.93893, 'lng': 6.95752, 'address': '50667 Koeln Altstadt-Nord'},
        'dus': {'all_id': -1001441637885, 'mrna_id': -1, 'vec_id': -1, 'lat': 51.22591, 'lng': 6.77356, 'address': '40213 Duesseldorf Altstadt'},
        'ber1': {'all_id': -1001311147212, 'mrna_id': -1, 'vec_id': -1, 'lat': 52.52003, 'lng': 13.40489, 'address': '10178 Berlin Mitte'},
        'ber2': {'all_id': -1001311147212, 'mrna_id': -1, 'vec_id': -1, 'lat': -1, 'lng': -1, 'address': ''},
        'ber3': {'all_id': -1001311147212, 'mrna_id': -1, 'vec_id': -1, 'lat': -1, 'lng': -1, 'address': ''},
        'ffm': {'all_id': -1001238323633, 'mrna_id': -1, 'vec_id': -1, 'lat': 50.1126, 'lng': 8.68343, 'address': '60311 Frankfurt am Main Innenstadt'},
        'hh': {'all_id': -1001237010945, 'mrna_id': -1, 'vec_id': -1, 'lat': 53.55, 'lng': 10, 'address': '20457 Hamburg Hamburg-Altstadt'},
