...
conf = {'muc1': {'token': '1851471777:AAHqNrWPAuvr7w5QRrjrnGvr0VJaWVC4BCo', 'chat_id': -1001464001536, 'lat': 48.13836, 'lng': 11.57939, 'address': '80333 Muenchen Altstadt-Lehel'},
        ...
        'lej': {'token': '', 'chat_id': -1, 'lat': 51.33983, 'lng': 12.37541, 'address': '04109 Leipzig Zentrum'},
        'bre': {'token': '', 'chat_id': -1, 'lat': 53.0778, 'lng': 8.80385, 'address': '28195 Bremen Altstadt'},
        'h': {'token': '', 'chat_id': -1, 'lat': 52.37387, 'lng': 9.73779, 'address': '30161 Hannover Mitte'},
        'drs': {'token': '', 'chat_id': -1, 'lat': 51.05174, 'lng': 13.73729, 'address': '01067 Dresden Innere Altstadt'},
        'fr': {'token': '', 'chat_id': -1, 'lat': 47.9953, 'lng': 7.85242, 'address': '79098 Freiburg im Breisgau Altstadt'},
        'erf': {'token': '', 'chat_id': -1, 'lat': 50.97961, 'lng': 11.02388, 'address': '99084 Erfurt Altstadt'},
        ...
        'dtm': {'token': '', 'chat_id': -1, 'lat': 51.51422, 'lng': 7.46509, 'address': '44137 Dortmund Mitte'},
        'ess': {'token': '', 'chat_id': -1, 'lat': 51.4564, 'lng': 7.00999, 'address': '45127 Essen Innenstadt'}
        }
...
def init(city):
    ...
    if is_helios_enabled(city):
        helios.helios_init()
        while True:
            if helios.helios_gather_locations(city, conf[city]['lat'], conf[city]['lng'], conf[city]['address']):
                break
